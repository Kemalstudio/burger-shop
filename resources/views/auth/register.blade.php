            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-9 col-sm-11">
                    <div class="auth-card text-center">
                        ...
                        <p class="auth-subtitle">Создайте профиль, чтобы стать частью клуба Burger Shop и получать эксклюзивные предложения.</p>
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group-custom">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Иван Иванов" required>
                                        @error('name')
                            ...
                            <div class="mt-4" style="font-family: 'Raleway', sans-serif; color: #aaa; font-size: 15px;">
                                Уже есть аккаунт? <a href="{{ route('login') }}" class="auth-link">Войти здесь</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        document.querySelectorAll('.toggle-password').forEach(function(icon) {
            icon.addEventListener('click', function() {
                ...
                if (input.type === 'password') {
                    ...
                    this.style.color = '#F0542C'; // Меняем цвет иконки на фирменный
                } else {
                    input.type = 'password';
                    // Возврат иконки
                    this.classList.remove('fa-eye-slash');
                    this.classList.add('fa-eye');
                    this.style.color = '#888'; // Возвращаем цвет по умолчанию
                }
            });
        });
    </script>
